...
- [{ggt.test} is a micro package to examine the logic of the
  t.test.](#ggttest-is-a-micro-package-to-examine-the-logic-of-the-ttest)
- [Data](#data)
  - [Scenario 1 📻⏱️](#scenario-1-radiostopwatch)
  - [Scenario 2 😮‍💨💪🧗](#scenario-2-face_exhalingmuscleclimbing)
  - [Senario 3 😴🛌 Sleeping 8 hours on
    average?](#senario-3-sleepingsleeping_bed-sleeping-8-hours-on-average)
- [Step 1. Visualizing raw data](#step-1-visualizing-raw-data)
- [Step 2: Visualizing mean and asserted population mean
  (NULL)](#step-2-visualizing-mean-and-asserted-population-mean-null)
- [Interlude: Individual hypothetical means based on
  null?](#interlude-individual-hypothetical-means-based-on-null)
- [Step 3. Collections of hypothetical means under the ‘null’, and where
...
People are played 10 second clip of a song. The are asked to estimate
how long the clip played (in seconds).

<img src="images/clipboard-2788773333.png" width="209" />
...
A random sample of campus students are asked to take the grit survey and
report their score. Is there evidence that this student group is
different than the West Point Population (2010), whose mean grit score
was 3.75.

<https://gwern.net/doc/psychology/personality/conscientiousness/2007-duckworth.pdf>

<img src="images/clipboard-2260850865.png" width="441" />

<https://unsplash.com/photos/a-group-of-people-hiking-up-a-mountain-lUNh8-Zhqo4>

<img src="images/clipboard-722410795.png" width="192" />

<img src="images/clipboard-2486868670.png" width="509" />
...
<img src="images/clipboard-1896477271.png" width="466" />

<img src="images/clipboard-4161110727.png" width="190" />
